...
import com.huiyan.huozhiwang.dao.OrderItemMapper;
import com.huiyan.huozhiwang.dao.OrderMapper;
import com.huiyan.huozhiwang.dao.ShoppingCartItemMapper;
...
public class OrderServiceImpl implements OrderService {
    ...
    public PageResult getMallOrdersPage(PageQueryUtil pageUtil) {
        List<MallOrder> mallOrders = orderMapper.findMallOrderList(pageUtil);
    ...
    public String saveOrder(UserVO user, List<ShoppingCartItemVO> myShoppingCartItems) {
        ...
        //检查是否包含已下架商品
        List<HuoZhiMallGoods> goodsListNotSelling = huoZhiMallGoods.stream()
        ...
        Map<Long, HuoZhiMallGoods> mallGoodsMap = huoZhiMallGoods.stream().collect(Collectors.toMap(HuoZhiMallGoods::getGoodsId, Function.identity(), (entity1, entity2) -> entity1));
        //判断商品库存
        ...
        //删除购物项
        if (!CollectionUtils.isEmpty(itemIdList) && !CollectionUtils.isEmpty(goodsIds) && !CollectionUtils.isEmpty(huoZhiMallGoods)) {
    ...
    public OrderDetailVO getOrderDetailByOrderNo(String orderNo, Long userId) {
        ...
        if (mallOrder != null) {
            ...
            if (!CollectionUtils.isEmpty(orderItems)) {
                ...
                orderDetailVO.setOrderStatusString(OrderStatusEnum.getMallOrderStatusEnumByStatus(orderDetailVO.getOrderStatus()).getName());
    ...
    public PageResult getMyOrders(PageQueryUtil pageUtil) {
        ...
        if (total > 0) {
            ...
            for (OrderListVO orderListVO : orderListVOS) {
                orderListVO.setOrderStatusString(OrderStatusEnum.getMallOrderStatusEnumByStatus(orderListVO.getOrderStatus()).getName());
            }
